...
# old$tg_token   = "5442649570:AAHO7-cxy5U6kCvaGIOZjNo8UwcozA4UA5E"
$tg_token   = "5442649570:AAECB61mW7S8YGAtlmW3JeQ2vt0hJ7_svoQ"
$tg_chat_id = "-1002276726102_2"
#$tg_chat_id = "-1002548730791_2"
...
function Copy-DBArchive-to-FTP-All {
  ...
  foreach ($ftp_name in Get-ChildItem $ftp_conf_dir) {
    $err_message = $err_message + (Copy-DBArchive-to-FTP "$tmp_backup_dir" "$ftp_conf_dir\$ftp_name")
    if ($err_message -eq "") {
