...
$main_form.Text ='Ñïèñîê ëîêàëüíûõ àäìèíèñòðàòîðîâ'
$main_form.Width = 500
...
$listView.Columns.Add('Êîìïüþòåð')
$listView.Columns.Add('Èìÿ àäìèíèñòðàòîðà')
$listView.Columns.Add('Ïàðîëü')
$listView.Columns.Add('Ñðîê äåéñòâèÿ ïàðîëÿ')
